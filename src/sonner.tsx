    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            'group-[.toast]:bg-primary group-[.toast]:text-primary-foreground font-medium rounded-2xl',
          cancelButton:
            'group-[.toast]:bg-muted group-[.toast]:text-muted-foreground font-medium rounded-2xl',
        },
      }}
      {...props}
    />
