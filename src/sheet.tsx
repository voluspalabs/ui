    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'right' &&
            'data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-4 size-auto h-full w-auto border-l sm:inset-y-4 sm:right-4 sm:left-auto sm:w-3/4 sm:max-w-sm',
          side === 'left' &&
            'data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-4 size-auto h-full w-auto border-r sm:inset-y-4 sm:right-auto sm:left-4 sm:w-3/4 sm:max-w-sm',
          side === 'top' &&
            'data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top inset-4 h-auto border-b sm:inset-x-4 sm:top-4 sm:bottom-auto',
          side === 'bottom' &&
            'data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-4 h-auto border-t sm:inset-x-4 sm:top-auto sm:bottom-4',
          className,
        )}
        {...props}
      >
